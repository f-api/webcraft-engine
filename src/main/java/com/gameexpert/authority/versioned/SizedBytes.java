...
/** Request buffer sized up front, so multi-megabyte carrier frames are neither regrown nor copied out. */
final class SizedBytes extends ByteArrayOutputStream {
    SizedBytes(long expected) {
